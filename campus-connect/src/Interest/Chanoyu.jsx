...
import img2 from '../img/Chanoyu.png';
      ...
      <div className="inner-box">
        ...
        <div className="right-box">
          ...
          <div className="contact1">
            ...
            <a href= "https://www.instagram.com/chanoyuclubuw/">
              <img src= {insta} alt="insta" className="socials" />
            </a>
          </div>
          <div className="contact2">
          <a href= " https://www.facebook.com/groups/chanoyuclubatuw">
